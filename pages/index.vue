...
<template>
    <!-- ------------------------------------ START - Hero ------------------------------------ -->
    <section class="mt-20 relative pb-8">
      <img class="w-full h-auto object-contain" src="/hero-bg-1.png" alt="Hero Background 1">
      <div
        class="container absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 mx-auto flex h-full w-full max-w-2xl flex-col items-center justify-center gap-6">
    ...
    <section v-for="data in home_sections" class="relative py-8">
      <div class="container mx-auto my-16 flex w-full max-w-screen-xl items-center justify-between px-20 2xl:px-10"
      ...
      <div class="container mx-auto my-16 w-full max-w-screen-xl px-20 2xl:px-10">
        ...
        <div class="flex flex-row items-start gap-8">
          <figure class="relative basis-1/4" v-for="data in choose_sections">
            <img v-if="data.illustration_src" class="absolute -z-0 h-auto w-full"
              :class="{ '-top-28': data.id === 1, '-top-36': data.id === 4 }" :src="data.illustration_src"
            ...
            <div
              ...
              <component :is="data.icon" class="text-grey-secondary-5 mb-10 h-20 w-20" />
    ...
    <section class="relative my-8 bg-grey-footer py-16">
      <div class="container mx-auto my-16 w-full max-w-screen-xl px-20 2xl:px-10">
        ...
        <div class="my-7 flex flex-row items-start gap-8">
          <figure v-for="data in experience_sections"
            ...
            <img class="mb-4 h-20 w-20 rounded-full" :src="data.src" :alt="data.alt" />
        ...
        <div class="flex flex-row items-center justify-center gap-1">
          <button v-for="data in 4" class="h-2 w-2 rounded-full bg-neutral-300 first:bg-baseline-primary">
            &nbsp;
          </button>
        </div>
      </div>
    ...
    <section class="relative my-16 py-16">
      <div class="container mx-auto my-16 w-full flex flex-col items-center justify-center max-w-screen-xl px-20 2xl:px-10">
        <img src="/bird-illustration-3.png" alt="Bird Illustration 3" class="w-56 h-56" />

        <h3 class="text-4xl my-8 font-extrabold text-grey-concencrated">
          Apa Yang Anda Tunggu? Bergabunglah Sekarang!
        </h3>
        <p class="max-w-3xl text-grey-smooth mx-auto text-center">
          Tidak perlu menunggu lagi. Jadilah bagian dari komunitas terbesar di Indonesia. Daftarkan diri Anda, temukan teman-teman baru, dan bagikan minat Anda bersama Cuit. Mari bersama-sama menciptakan pengalaman media sosial yang lebih bermakna!
        </p>
      </div>
    </section>
    <!-- ------------------------------------ END - Join Now ------------------------------------ -->
